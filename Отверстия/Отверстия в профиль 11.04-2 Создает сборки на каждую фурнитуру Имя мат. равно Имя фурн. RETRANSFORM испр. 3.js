/**
 * ЭТАП 1: Создание профилей-цилиндров для ВСЕХ отверстий в модели
 * ИСПРАВЛЕНО: Корректная работа при запуске из редактора и как макроса
 */
var createdProfiles = {};
...
function CreateProfileForHole(hole, fastener, panel, holeIndex, fastIndex, panelPath) {
	try {
		...
		extr.Contour.AddCircle(0, 0, radius);
